...
class Scorer {
  private static final int[] COLUMN = {0, 0, 0, 50, 100, 150, 200, 350, 500, 500, 0};
  private static final int[] WORDS = {0, 0, 0, 10, 20, 50, 100, 150, 250, 500, 1500};
  private static final int[] BONUSES = {0, 0, 0, 300, 500, 800, 1200, 1850, 0, 0, 0};

  int score(String... words) {
    return score(Arrays.asList(words));
  }

  int score(Iterable<String> words) {
